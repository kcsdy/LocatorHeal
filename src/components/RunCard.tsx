...
export default function RunCard({
  ...
  const canRun =
    connected && config.repoUrl.trim() !== "" && config.websiteUrl.trim() !== "" && !isRunning;
    ...
    <div className="runCard">
      <div className="runHeader">
        <div>
          ...
          <p className="runSub">Provide a GitHub repo URL, the website URL, and run.</p>
        </div>
      ...
      <label htmlFor="repo">GitHub repository URL (test framework)</label>
      <input
        id="repo"
      ...
      <label htmlFor="website">Website URL (app under test)</label>
      <input
        id="website"
      ...
      <div className="runActions">
        <button className="btn primary" type="button" onClick={onRun} disabled={!canRun}>
